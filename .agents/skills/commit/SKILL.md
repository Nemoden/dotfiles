---
name: commit
description: "Create git commits using Conventional Commits format. Use whenever making a git commit, whether explicitly requested or as part of a larger workflow."
---
