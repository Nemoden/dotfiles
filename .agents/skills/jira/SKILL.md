...
### Pre-flight: ask sprint placement

Before any create call, ask: active sprint / next sprint / backlog. Skip only if user stated placement.

```bash
jira sprint list --state active     # current
